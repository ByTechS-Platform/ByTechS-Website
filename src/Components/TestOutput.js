...
const TestOutput = ({ score }) => {
  ...
  const profiles = {
    TechInnovator: {
      ...
      image: charactersImages.TechInnovator,
      alt: isArabic
    ...
    LogicalAnalyst: {
      ...
      image: charactersImages.LogicalAnalyst,
      alt: isArabic
    ...
    PracticalUser: {
      ...
      image: charactersImages.PracticalUser,
      alt: isArabic
    ...
    CuriousExplorer: {
      ...
      image: charactersImages.CuriousExplorer,
      alt: isArabic
  ...
  const { title, paragraphs, image, alt } = profiles[profileKey];
...
/*
المستكشف الفضولي | CuriousExplorer
